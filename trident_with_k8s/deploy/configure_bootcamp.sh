...
kubectl apply -f /root/netapp-bootcamp/trident_with_k8s/deploy/k8s_files/metallb-configmap-k8s-prod.yaml
...
kubectl apply -f /root/netapp-bootcamp/trident_with_k8s/deploy/monitoring/grafana/cm-grafana-datasources.yaml
kubectl create configmap cm-grafana-dashboard -n monitoring --from-file=/root/netapp-bootcamp/trident_with_k8s/deploy/monitoring/grafana/dashboards/
...
kubectl apply -f /root/netapp-bootcamp/trident_with_k8s/deploy/monitoring/grafana/deployment-prom-operator-grafana.yaml
...
echo ""
echo "[root@rhel3 ~]# tridentctl -n trident create backend -f /root/netapp-bootcamp/trident_with_k8s/deploy/k8s_files/backend-nas-default.json"
tridentctl -n trident create backend -f /root/netapp-bootcamp/trident_with_k8s/deploy/k8s_files/backend-nas-default.json
echo ""
echo "[root@rhel3 ~]# tridentctl -n trident create backend -f /root/netapp-bootcamp/trident_with_k8s/deploy/k8s_files/backend-nas-eco-default.json"
tridentctl -n trident create backend -f /root/netapp-bootcamp/trident_with_k8s/deploy/k8s_files/backend-nas-eco-default.json
echo ""
echo "[root@rhel3 ~]# tridentctl -n trident create backend -f /root/netapp-bootcamp/trident_with_k8s/deploy/k8s_files/backend-san-default.json"
tridentctl -n trident create backend -f /root/netapp-bootcamp/trident_with_k8s/deploy/k8s_files/backend-san-default.json
echo ""
echo "[root@rhel3 ~]# tridentctl -n trident create backend -f /root/netapp-bootcamp/trident_with_k8s/deploy/k8s_files/backend-san-eco-default.json"
tridentctl -n trident create backend -f /root/netapp-bootcamp/trident_with_k8s/deploy/k8s_files/backend-san-eco-default.json
echo ""
...
kubectl create -f /root/netapp-bootcamp/trident_with_k8s/deploy/k8s_files/sc-csi-ontap-nas.yaml
echo ""
echo "[root@rhel3 ~]# kubectl create -f sc-csi-ontap-nas-eco.yaml"
kubectl create -f /root/netapp-bootcamp/trident_with_k8s/deploy/k8s_files/sc-csi-ontap-nas-eco.yaml
echo ""
echo "[root@rhel3 ~]# kubectl create -f sc-csi-ontap-nas.yaml"
kubectl create -f /root/netapp-bootcamp/trident_with_k8s/deploy/k8s_files/sc-csi-ontap-san.yaml
echo ""
echo "[root@rhel3 ~]# kubectl create -f sc-csi-ontap-nas-eco.yaml"
kubectl create -f /root/netapp-bootcamp/trident_with_k8s/deploy/k8s_files/sc-csi-ontap-san-eco.yaml
echo ""
...
kubectl create -f /root/netapp-bootcamp/trident_with_k8s/deploy/k8s_files/dashboard-service-account.yaml

echo ""
echo "[root@rhel3 ~]# kubectl create -f dashboard-clusterrolebinding.yaml"
kubectl create -f /root/netapp-bootcamp/trident_with_k8s/deploy/k8s_files/dashboard-clusterrolebinding.yaml
...
ssh -o "StrictHostKeyChecking no" root@rhel4 < /root/netapp-bootcamp/trident_with_k8s/deploy/01_prepare_prod_k8s_server_rhel4.sh
ssh -o "StrictHostKeyChecking no" root@rhel4 < /root/netapp-bootcamp/trident_with_k8s/deploy/02_join_prod_k8s_cluster_rhel4.sh

echo "#######################################################################################################"
echo "Initialize and configure the dev kubernetes cluster"
echo "#######################################################################################################"

ssh -o "StrictHostKeyChecking no" root@rhel5 < /root/netapp-bootcamp/trident_with_k8s/deploy/03_prepare_dev_k8s_servers.sh
ssh -o "StrictHostKeyChecking no" root@rhel6 < /root/netapp-bootcamp/trident_with_k8s/deploy/03_prepare_dev_k8s_servers.sh

ssh -o "StrictHostKeyChecking no" root@rhel5 < /root/netapp-bootcamp/trident_with_k8s/deploy/04_init_dev_k8s_master_rhel5.sh
ssh -o "StrictHostKeyChecking no" root@rhel6 < /root/netapp-bootcamp/trident_with_k8s/deploy/05_join_dev_k8s_cluster_rhel6.sh

ssh -o "StrictHostKeyChecking no" root@rhel5 < /root/netapp-bootcamp/trident_with_k8s/deploy/06_configure_dev_k8s_cluster.sh
